...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppCountriesStatisticsCountriesStatisticsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CountriesStatisticsComponent_mat_option_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 17);
    ...
    function CountriesStatisticsComponent_div_22_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesStatisticsComponent_linechart_component_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesStatisticsComponent_bar_chart_mobile_component_25_Template(rf, ctx) {
      if (rf & 1) {
    ...
    CountriesStatisticsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CountriesStatisticsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function CountriesStatisticsComponent_Template_mat_select_valueChange_18_listener($event) {
            return ctx.selectedTimeRange = $event;
          })("selectionChange", function CountriesStatisticsComponent_Template_mat_select_selectionChange_18_listener($event) {
            return ctx.selectTimeRange($event);
          });
